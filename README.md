...
## Door Mecanism
The door itself is a metal sheet with a row of holes along its length. The teth on the motor engage in these holes and move the plate up or down while the motor spinns. The Door aditionally includes a magnet on each side. Thanks to these magnets, a magnet sensor can be used to determinde if the door has reached the open/close position and should be stopped. 
...
The second code block "IO pins" can be modified to sellect the correct gpio pins for sensors etc. of your configuration.
